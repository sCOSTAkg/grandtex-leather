...
const getCollection = (id: string) => {
  const collections = {
    "spring-summer-2027": {
      ...
      title: "Весна-Лето 27",
      headline: "Ускоряйтесь вперёд",
      description:
        "От спортзала до ежедневных поездок коллекция SS27 отражает глубину и масштаб того, что GRANDTEX делает лучше всего — создаёт универсальные изделия, которые адаптируются под ваши нужды.",
      longDescription:
        "В рамках нашего ребрендинга этот сезон ознаменует обновлённое стремление обслуживать бренды любого размера с точностью, целью и партнёрством. Независимо от того, создаёте ли вы массовые линии или лимитированные силуэты, наша продукция готова адаптироваться. От гладких фулгрейнов до прочных нубуков — каждый материал является результатом экспертного мастерства и промышленной точности, поддержанной обновлённой идентичностью бренда, созданной для движения вперёд. Это GRANDTEX — обновлённый, утончённый и готовый идти вместе с вами.",
      season: "Весна-Лето",
      year: "2027",
      ...
      themes: [
        {
          ...
          description:
            "Материалы, созданные для адаптации к различным применениям при сохранении естественной привлекательности.",
        },
        {
          title: "Городская функциональность",
          description:
            "Прочные и изящные материалы, выдерживающие ритм городской жизни без потери стиля.",
        },
        {
          title: "Устойчивая роскошь",
          description:
            "Премиальные материалы, созданные с соблюдением экологически ответственных процессов.",
        },
      ],
    },
    fw26: {
      ...
      description:
        "Наша коллекция Осень-Зима 26 сочетает прочность и изящество, предлагая премиальные изделия, разработанные для холодного сезона.",
      longDescription:
        "Коллекция Осень-Зима 26 вдохновлена стойкостью природы в зимние месяцы. Мы разработали материалы, которые обеспечивают тепло и защиту без ущерба для стиля и гибкости. Этот сезон отличается богатыми текстурами, глубокими оттенками и инновационными отделками, которые прекрасно проявляют себя в сложных условиях. Каждое изделие коллекции протестировано на прочность, устойчивость к погоде и комфорт, чтобы удовлетворить требования как дизайнеров, так и конечных пользователей.",
      season: "Осень-Зима",
      year: "2026",
      ...
      themes: [
        {
          title: "Зимняя стойкость",
          description:
            "Кожи, сохраняющие свои свойства и внешний вид в холодных и влажных условиях.",
        },
        {
          title: "Тактильная глубина",
          description:
            "Богатые текстуры, придающие объём и выразительность сезонным дизайнам.",
        },
        {
          title: "Изысканная защита",
          description:
            "Элегантные отделки с повышенной долговечностью для зимней носки.",
        },
      ],
    },
  };
    ...
    return (
      <MainLayout transparentHeader={{ transparent: false }}>
        <div className="py-40 px-8 text-center">
          ...
          <p className="mb-8">
            Коллекция, которую вы ищете, не существует или была удалена.
          </p>
          <Link
            href="/collections"
    ...
    <MainLayout transparentHeader={{ transparent: false }}>
      <div className="mt-20">
        ...
        <section className="py-16 px-8 bg-secondary">
          <div className="container mx-auto">
            <h2 className="text-3xl font-bold mb-12">Избранные изделия</h2>
        ...
        <section className="py-16 px-8">
          <div className="container mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-12 max-w-3xl">
              ...
              применения изделий этого сезона.
            </p>
        ...
        <section className="py-16 px-8 bg-primary text-primary-foreground">
          <div className="container mx-auto text-center">
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto">
              Свяжитесь с нашей командой, чтобы запросить образцы, подробные
              спецификации или обсудить индивидуальные варианты применения.
            </p>
